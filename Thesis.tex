...
\usepackage{tabularx}   % you use tabularx inside it
...
\begin{center}
\begin{doublespace}
{\textbf{{\large Discovery and Design of novel Bacterial Retrons systems using Traditional Computational and AI Methods
}}}%\vfill % Write your thesis title
\end{doublespace}

\vspace{10mm}
{Thesis/Dissertation by}\\
{Melissa Maria Rios Zertuche} %\vfill
...
Melissa Maria Rios Zertuche\\               % write your First name second name
All rights reserved\\

\orcid{} \small \href{https://orcid.org/0000-0001-2345-6789}{https://orcid.org/0009-0000-6367-2005}\\
\end{onehalfspace}
